  ...
  return (
    <div className="Header">
      ...
      <div className="HeaderButtonWrapper">
        {/* <div className="asd"> USER </div>
        <div className="asd"> ETHER </div> */}
        <div className="HeaderMain" style={{ zIndex: 1 }}>
          Ether
          <svg
          ...
          <div className="HeaderSubWrapper">
            <div className="HeaderSub">
              ...
              <div
                className={
                  "HeaderButton deco" +
                  (loc.pathname == "/Profile" ? " Activated" : " ")
                }
              ...
              <div
                className={
                  "HeaderButton deco" +
                  (loc.pathname == "/Gallery" ? " Activated" : " ")
                }
        ...
        <div className="HeaderMain" style={{ zIndex: 2 }}>
          The Vision
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
          ...
          <div className="HeaderSubWrapper">
            <div className="HeaderSub">
              <div
                className={
                  "HeaderButton deco" +
                  (loc.pathname == "/Roadmap" ? " Activated" : " ")
                }
              ...
              <div
                className={
                  "HeaderButton deco" +
                  (loc.pathname == "/News" ? " Activated" : " ")
                }
                onClick={() => delayNav("/News")}
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="HeaderMain" style={{ zIndex: 3 }}>
          Socials
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
          ...
          <div className="HeaderSubWrapper">
            <div className="HeaderSub">
              <div
                className={"HeaderButton deco"}
                onClick={() => handleClick("https://x.com/ether")}
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                className={"HeaderButton deco"}
                onClick={() =>
                  handleClick("https://www.instagram.com/ether.site/")
                }
              >
                <div>
                  <svg
              ...
              <div
                className={"HeaderButton deco"}
                onClick={() => handleClick("https://discord.com/invite/ether")}
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                className={"HeaderButton deco"}
                onClick={() => handleClick("https://ether.site/")}
              >
                <div>
                  <div className="AboutEtherIcon" />
                  Ether.site
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="HeaderMain" style={{ zIndex: 4 }}>
          Account
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            ...
            <div className="HeaderSub">
              {user ? (
                <>
                  <div
                    className={
                      "HeaderButton deco" +
                      (loc.pathname.startsWith("/Profile/Edit/")
                        ? " Activated"
                        : " ")
                    }
                    onClick={() => delayNav(`/Profile/Edit/${user}`)}
                  >
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              {user ? null : (
                <div
                  className={
                    "HeaderButton deco" +
                    (loc.pathname == "/Register" ? " Activated" : " ")
                  }
                  onClick={() => delayNav("/Register")}
                >
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              {user ? null : (
                <div
                  className={
                    "HeaderButton deco" +
                    (loc.pathname == "/Login" ? " Activated" : " ")
                  }
                  onClick={() => delayNav("/Login")}
                >
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
